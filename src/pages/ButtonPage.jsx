    ...
    <div>
      <main id='main-content'>
        ...
        <p>
          ...
          knappar med olika stilar och funktioner. Buttons-komponenten erbjuder
          tre olika typer av knappar:
        </p>
        <ol>
          <li>
        ...
        <ul>
          <li>
            <strong>Skärmläsarstöd:</strong>
            <p>
              För knappen med endast ikon har vi lagt till dold text för
              skärmläsare.
            </p>
          </li>
          <li>
            ...
            <code>aria-atomic="true"</code> används för att meddela användaren
            om vilken knapp som har klickats.
          </li>
          <li>
          ...
          <li>
            <strong>Fokusindikatorer:</strong> Förbättra
            tangentbordsnavigeringen med CSS-stil.
          </li>
        </ul>
        <hr />
